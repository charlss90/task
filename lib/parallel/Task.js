...
module.exports = function (list) {
  ...
  var getCurrentListItem = function () {
    if (list[workItemIndex] && !list[workItemIndex].toJson) {
      throw new TypeError('Unexpected Argument:: Task->getCurrentListItem item list should be implement toJson');
    }
    return list[workItemIndex].toJson();
  };
